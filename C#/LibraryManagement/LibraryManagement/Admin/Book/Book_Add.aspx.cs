...
namespace Library.Admin.Book
{
    public partial class Book_Add : System.Web.UI.Page
    {
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "INSERT INTO Books (name,author,press,press_time,price,ISBN,descs) VALUES ('" + name.Text.Trim() + "','" + author.Text.Trim() + "','" + press.Text.Trim() + "','" + pressTime.Text.Trim() + "','" + price.Text.Trim() + "','" + ISBN.Text.Trim() + "','" + desc.Text.Trim() + "')";
