            ...
            <div class="container">
                <div class="form">
                    ...
                    <form id="form1" runat="server">
                        <div class="inputBox">
                            <asp:TextBox ID="txtUserName" runat="server" placeholder="请输入用户ID" 
                        ...
                        <div class="inputBox">
                            <asp:TextBox ID="Password" type="password" runat="server" placeholder="请输入密码" 
                                autocomplete="new-password" ></asp:TextBox>
                        </div>
                        <div class="inputBox">
                        ...
                        <div class="inputBox">
                            <asp:Button ID="Submit" runat="server" Text="提交" OnClick="Button_Register" />
                        </div>
                        <p class="forget">
                            已有账户?<a href="Index.aspx">立即登录</a>
                        </p>
                    </form>
                </div>
            </div>
