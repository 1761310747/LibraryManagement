...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="fluid">
                        <div class="row">
                <div class="col-lg-6"><b>我的信息</b></div>
                <hr />
            </div>
            <p>
                用户ID：<asp:Label ID="Id" runat="server" Text="Label"></asp:Label>
            </p>
            <p>
                用户姓名：<asp:Label ID="Name" runat="server" Text="Label"></asp:Label>
            </p>
            <p>
                用户班级：<asp:Label ID="Class1" runat="server" Text="Label"></asp:Label>
            </p>
            <p>
                用户状态：<asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
            </p>
            <div style="width: 200px; overflow: hidden; display: flex; justify-content: space-between">
                <span class="btn btn-primary" data-toggle="modal" data-target="#lost">
                    <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>账户</span>
                <span class="btn btn-warning" data-toggle="modal" data-target="#pwd">修改密码</span>
            </div>

            <div class="row" style="margin-top: 40px;">
                <div class="col-lg-6"><b>我的借阅信息</b></div>
                <hr />
            </div>
            ...
            <div class="modal-dialog" style="margin-top: 150px;">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">挂失账户
                        </h4>
                    </div>
        ...
        <div class="modal fade" id="pwd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" style="margin-top: 150px;">
                <div class="modal-content">
                    <form id="form">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel">修改密码
                            </h4>
                        </div>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            $(".t1 table").eq(0).addClass("grid table text-center")
